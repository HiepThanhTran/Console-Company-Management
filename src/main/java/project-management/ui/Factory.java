...
import quanlyduan.service.DepartmentManager;
import quanlyduan.service.EmployeeManager;
import quanlyduan.service.JoinProjectManager;
import quanlyduan.service.ProjectManager;
import quanlyduan.service.ProvideInsuranceManager;
import quanlyduan.utils.StringUtils;

public class Factory {

    public static final File departmentFile = new File("src/main/resources/quanlyduan/DepartmentList.txt");
    public static final File employeeFile = new File("src/main/resources/quanlyduan/EmployeeList.txt");
    public static final File relativeFile = new File("src/main/resources/quanlyduan/RelativeList.txt");
    public static final File projectFile = new File("src/main/resources/quanlyduan/ProjectList.txt");
